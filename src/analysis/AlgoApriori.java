...
public class AlgoApriori {
	 ...
	 * @param fileInput  the path of an input file
	 * @param fileOutput the path of an input if the result should be saved to a file. If null,
	 ...
	 */
	public Itemsets runAlgorithm(double minsup, String fileInput, String fileOutput) throws IOException {
